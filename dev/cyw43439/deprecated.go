...
func printDeprecationOnce() {
	deprecated.Do(func() {
		println("github.com/tinygo-org/whd/dev/cyw43439: use of deprecated MACAs6 or TryPoll *Device method. Will be removed in future version. This message is only printed once")
	})
}
